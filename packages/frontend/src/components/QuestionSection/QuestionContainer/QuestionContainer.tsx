...
export function QuestionContainer() {
  ...
  return (
    <Container
      ...
      {!quizContext.loading && quizContext.currentQuestion && quizContext.currentQuestion.options ? (
        <Grid
          container
          direction="column"
          sx={{
          ...
          <Grid item xs={3} sx={{ display: 'flex', width: isDesktop ? '35%' : '65%' }}>
          ...
          <Grid item xs={3} sx={{ display: 'flex', width: isDesktop ? '45%' : '65%' }}>
